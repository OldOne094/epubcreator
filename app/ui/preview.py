...
class PreviewPage(QWidget):
    ...
    def __init__(self, state, view: QTextBrowser | None = None) -> None:  # noqa: ANN001
        ...
        self.view.setAccessibleName("معاينة الكتاب")
        self.view.setAccessibleDescription("عرض حي لشكل الكتاب قبل التصدير")

        controls = QHBoxLayout()
        controls.setSpacing(10)
        view_label = QLabel("عرض:")
        self.chapter_combo = QComboBox()
        self.chapter_combo.setAccessibleName("نطاق المعاينة")
        view_label.setBuddy(self.chapter_combo)
        ...
        dir_label = QLabel("الاتجاه:")
        self.direction_combo = QComboBox()
        self.direction_combo.setAccessibleName("اتجاه المعاينة")
        dir_label.setBuddy(self.direction_combo)
